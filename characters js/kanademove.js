...
stroke(115,173,68);
 ...
 image(kanadeIcon,kanadeIconProp.x, kanadeIconProp.y, 70,70);
...
function keyPressed() {
  if (keyCode === UP_ARROW)
   { kanadeIconProp.y -= kanadeIconProp.speed ;
   
  } else if (keyCode === DOWN_ARROW) {
    kanadeIconProp.y += kanadeIconProp.speed;
  }
  else if (keyCode === LEFT_ARROW) {
    kanadeIconProp.x -= kanadeIconProp.speed ;
